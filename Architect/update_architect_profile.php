            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="profile-box profile-info-box">
                        ...
                        <h3 class="profile-name"><?php echo ($architect['arch_name']); ?></h3>
                        <p class="profile-status">Professional Architect</p>
                        
                        <div class="profile-about">
                            <h4 class="about-title">📋 About</h4>
                            <p class="about-text">
                                <?php echo !empty($architect['about']) ? ($architect['about']) : 'No about information provided yet. Please update your profile to add information about yourself.'; ?>
                            </p>
                    ...
                    <div class="profile-box edit-form-box">
                        ...
                        <form action="profile_action.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="arch_name"
                            ...
                            <!-- Third Row: Location and Profile Picture (2 columns) -->
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <!-- Fourth Row: About Section (full width) -->
                            <div class="form-group">
                                <label class="form-label">About</label>
                                <textarea class="form-control" name="about" rows="4" 
                                          placeholder="Tell us about yourself, your experience, and specializations..."><?php echo ($architect['about']); ?></textarea>
                                <small class="text-muted">Describe your professional background and expertise</small>
                            </div>
